...
var index = require('./lib/eventemitter3/index.cjs');
...
class DiscordSDK {
    ...
    handshake() {
        ...
        if (this.platform === Constants.Platform.DESKTOP || majorMobileVersion >= Constants.HANDSHAKE_SDK_VERSION_MINIUM_MOBILE_VERSION) {
